            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <!-- Accueil Admin -->
                        <a class="nav-link" href="<?= base_url('index.php/compte/admin_accueil') ?>">
                        ...
                        <!-- Comptes -->
                        <a class="nav-link" href="<?= base_url('index.php/compte/lister') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-users"></i></div>
                            Comptes
                        </a>

                        <a class="nav-link" href="<?= base_url('index.php/message/contact') ?>">
                        ...
                        <a class="nav-link" href="<?= base_url('index.php/compte/get_ressource') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Gestion des ressources
                        </a>

                         <a class="nav-link" href="<?= base_url('index.php/compte/reservations_formulaire_date_admin') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div>
                            Séances réservées
                        </a>
